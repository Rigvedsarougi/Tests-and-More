...
def overlay_receipt_on_letterhead(receipt_path, letterhead_path, output_path, 
    ...
    for i in range(max_pages):
        ...
        # Only apply transformations if the current page matches target_page (if specified)
        ...
        # Merge the (transformed if target) receipt page onto the new page with the letterhead
